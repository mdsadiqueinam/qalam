...
const variantClassMap = {
  primary:
    "gap-1 bg-primary text-primary-text border border-divider dark:border-black hover:enabled:bg-primary-hover hover:enabled:text-primary-text-hover focus:enabled:ring-2 focus:enabled:ring-primary/20 focus:enabled:ring-offset-2 transition-[border,background-color,color,opacity,box-shadow] duration-300 shadow-lg shadow-primary/20",
  danger:
...
const variantIsOpenClassMap = {
  ...
  transparent: "",
  filter:
    "!border-divider-hover !bg-main-unselected-hover !text-main-text-hover",
};
...
const baseClasses = computed(() => {
  return [
    "inline-flex items-center justify-center disabled:cursor-not-allowed disabled:opacity-80 whitespace-nowrap select-none font-bold font-sans",
    !props.iconOnly ? "rounded-lg" : "",
    fontClass.value,
    heightClass.value,
    widthClass.value,
    paddingClass.value,
